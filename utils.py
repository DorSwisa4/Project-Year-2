...
def add_to_sql(obj):
    ...
    if isinstance(obj, classes.Manager):
    ...
    elif isinstance(obj, classes.Pilot):
    ...
    elif isinstance(obj, classes.Attendant):
    ...
    elif isinstance(obj, classes.GuestCustomer):
    ...
    elif isinstance(obj, classes.RegisteredCustomer):
    ...
    elif isinstance(obj, classes.Plane):
    ...
    elif isinstance(obj, classes.FlightClass):
    ...
    elif isinstance(obj, classes.Seat):
    ...
    elif isinstance(obj, classes.OperatingLine):
    ...
    elif isinstance(obj, classes.Flight):
    ...
    elif isinstance(obj, classes.Order):
    ...
    elif isinstance(obj, classes.Ticket):
